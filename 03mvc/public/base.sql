...
-- Schema 3mvc
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `3mvc` DEFAULT CHARACTER SET utf8 ;
USE `3mvc` ;

-- -----------------------------------------------------
-- Table `3mvc`.`Proveedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Proveedores` (
...
-- -----------------------------------------------------
-- Table `3mvc`.`Productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Productos` (
...
-- -----------------------------------------------------
-- Table `3mvc`.`Unidad_Medida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Unidad_Medida` (
...
-- Table `3mvc`.`IVA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`IVA` (
...
-- Table `3mvc`.`Kardex`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Kardex` (
  ...
  CONSTRAINT `fk_Kardex_Unidad_Medida`
    ...
    REFERENCES `3mvc`.`Unidad_Medida` (`idUnidad_Medida`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Kardex_IVA1`
    ...
    REFERENCES `3mvc`.`IVA` (`idIVA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Proveedores1`
    FOREIGN KEY (`Proveedores_idProveedores`)
    REFERENCES `3mvc`.`Proveedores` (`idProveedores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Productos1`
    FOREIGN KEY (`Productos_idProductos`)
    REFERENCES `3mvc`.`Productos` (`idProductos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `3mvc`.`Clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Clientes` (
...
-- Table `3mvc`.`Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Factura` (
  ...
  CONSTRAINT `fk_Factura_Clientes1`
    ...
    REFERENCES `3mvc`.`Clientes` (`idClientes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3mvc`.`Detalle_Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3mvc`.`Detalle_Factura` (
  ...
  CONSTRAINT `fk_Detalle_Factura_Factura1`
    ...
    REFERENCES `3mvc`.`Factura` (`idFactura`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Factura_Kardex1`
    FOREIGN KEY (`Kardex_idKardex`)
    REFERENCES `3mvc`.`Kardex` (`idKardex`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
