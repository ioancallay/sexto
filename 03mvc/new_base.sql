...
-- -----------------------------------------------------
-- Schema ioasyste_sexto
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema ioasyste_sexto
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ioasyste_sexto` DEFAULT CHARACTER SET utf8 ;
USE `ioasyste_sexto` ;

-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Proveedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Proveedores` (
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Productos` (
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Unidad_Medida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Unidad_Medida` (
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`IVA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`IVA` (
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Kardex`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Kardex` (
  ...
  CONSTRAINT `fk_Kardex_Unidad_Medida`
    ...
    REFERENCES `ioasyste_sexto`.`Unidad_Medida` (`idUnidad_Medida`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Kardex_IVA1`
    ...
    REFERENCES `ioasyste_sexto`.`IVA` (`idIVA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Proveedores1`
    FOREIGN KEY (`Proveedores_idProveedores`)
    REFERENCES `ioasyste_sexto`.`Proveedores` (`idProveedores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Productos1`
    FOREIGN KEY (`Productos_idProductos`)
    REFERENCES `ioasyste_sexto`.`Productos` (`idProductos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Clientes` (
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Factura` (
  ...
  CONSTRAINT `fk_Factura_Clientes1`
    ...
    REFERENCES `ioasyste_sexto`.`Clientes` (`idClientes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ioasyste_sexto`.`Detalle_Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ioasyste_sexto`.`Detalle_Factura` (
  ...
  CONSTRAINT `fk_Detalle_Factura_Factura1`
    ...
    REFERENCES `ioasyste_sexto`.`Factura` (`idFactura`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Factura_Kardex1`
    FOREIGN KEY (`Kardex_idKardex`)
    REFERENCES `ioasyste_sexto`.`Kardex` (`idKardex`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
